...
import { Patient, NonSensitivePatient, NewPatientEntry, EntryWithoutId, Entry } from '../types/Patient';
...
export const addEntryToPatient = (patientId: string, entry: EntryWithoutId): Entry => {
